...
#' @export 
QAR2K1 <- function(Y, n.sims = 10000, inits = rep(0, 7), prior = 3 / 2, tol = 10e-16) {
  ...
  # for 1
  for (b in 1:25) {
    params <- rwBmetropolisQAR2K1(params, I, T, L, Y, prior, tol)
  ...
  # for 2
  for (b in 26:100) {
    params <- rwBmetropolisQAR2K1(params, Sigma[[2]] + I, T, L, Y, prior, tol)
