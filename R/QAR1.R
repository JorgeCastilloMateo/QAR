...
#' @export 
QAR1K1 <- function(Y, n.sims = 10000, inits = rep(0, 4), prior = 3, tol = 10e-16) {
  ...
  # for 1
  for (b in 1:25) {
    params <- rwBmetropolisQAR1K1(params, I, T, L, Y, prior, tol)
  ...
  # for 2
  for (b in 26:100) {
    params <- rwBmetropolisQAR1K1(params, Sigma[[2]] + I, T, L, Y, prior, tol)
...
#'   \item{\code{y}}{Data fitted}
#' @export 
QAR1K2 <- function(Y, n.sims = 10000, inits = rep(0, 10), prior = 3 / 2, tol = 10e-16) {
  ...
  # for 1
  for (b in 1:25) {
    params <- rwBmetropolisQAR1K2(params, I, T, L, Y, prior, tol)
  ...
  # for 2
  for (b in 26:100) {
    params <- rwBmetropolisQAR1K2(params, Sigma[[2]] + I, T, L, Y, prior, tol)
...
#' @export 
QAR1K <- function(Y, K = 8, coef = c(.5,.5,1,1,.5,2,2,.5,1,16,16,1,4,8,8,4), n.sims = 10000, inits = rep(0, 14), prior = 3, tol = 10e-16) {
  ...
  # for 1
  for (b in 1:25) {
    params <- rwBmetropolisQAR1K(params, I, T, L, Y, K, coef, prior, tol)
  ...
  # for 2
  for (b in 26:100) {
    params <- rwBmetropolisQAR1K(params, Sigma[[2]] + I, T, L, Y, K, coef, prior, tol)
